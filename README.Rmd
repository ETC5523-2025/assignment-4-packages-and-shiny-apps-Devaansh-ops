---
title: "blacksummer: Exploring Australia’s Black Summer Bushfire Risk"
...
<a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="License: MIT"/></a> <a href="https://www.r-project.org/"><img src="https://img.shields.io/badge/R-%3E%3D4.1.0-1f425f.svg" alt="R version"/></a>
...
Wildfire and climate attribution data are often difficult to explore without\
...
A full narrative vignette (“Burning Point: Climate, Data, and Responsibility”)\
explains the scientific context behind the bushfire risk indicators.

Visit the full documentation site:

👉 [**https://etc5523-2025.github.io/assignment-4-packages-and-shiny-apps-Devaansh-ops/**](https://etc5523-2025.github.io/assignment-4-packages-and-shiny-apps-Devaansh-ops/){.uri}
